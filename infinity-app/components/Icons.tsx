...
export function SlopyCurvyArrow({ className }: { className?: string }) {
    return (
        <svg width="87" height="56" viewBox="0 0 87 56" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("", className)}>
            <path d="M2.67557 7.52747C9.76254 5.32319 16.6683 2.80385 24.4711 3.165C26.8481 3.27501 34.9084 3.26682 36.5905 5.52322C41.1773 11.6757 24.4535 21.2676 21.3219 23.967C13.2699 30.9076 10.9424 38.3428 24.8536 41.9874C39.8596 45.9189 59.8394 47.2209 74.7903 45.2648C78.7455 44.7474 88.0145 45.9778 80.666 42.2392C78.0276 40.8969 67.0278 35.0365 75.1196 40.3556C75.8407 40.8295 84.5896 44.9991 84.4076 45.3568C83.9671 46.2227 78.413 47.5163 77.2308 48.3826C75.1817 49.8841 73.3435 50.544 72.1839 52.8232" stroke="#222222" strokeWidth="5" strokeLinecap="round" />
        </svg>
    )
}